...
-- Volcando datos para la tabla biblioteca.autores: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla biblioteca.consulta: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla biblioteca.detalle: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla biblioteca.usuarios: ~2 rows (aproximadamente)
